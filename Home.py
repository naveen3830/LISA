...
def load_sidebar():
    ...
    with st.sidebar:
        ...
        st.session_state['model_name'] = st.selectbox("Select Model:", 
                                                    ["llama-3.3-70b-versatile","deepseek-r1-distill-llama-70b","llama3-70b-8192", "mixtral-8x7b-32768", "gemma2-9b-it"], 
    ...
    with tab2:
        ...
        if not st.session_state['groq_api_key']:
            ...
            if user_query is not None and user_query != "":
                ...
                with open(f"{project_name}/exception/__init__.py","w") as f:
